...
#include "mpeg/id3v2/id3v2tag.h"//tag
#include <mpeg/id3v2/id3v2frame.h>//frame
#include <fileref.h>
...
int main(void)
{
	...
	FileRef f(" C:/Users/RazLT/My Music/(2000) Outkast - Stankonia/05 - Outkast - Mrs. Jackson.mp3");
	cout << f.tag()->artist().toCString();
